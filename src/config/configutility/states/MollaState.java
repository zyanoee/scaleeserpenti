...
public class MollaState implements EditBoardState{
    ...
    public MollaState(EditBoardView ebview, EditBoardInterface eboard, EditBoardController ebcontroller){
        this.ebview = ebview;
        this.eboard = eboard;
        this.ebcontroller = ebcontroller;
        available = true;
        color = Color.decode("#964B00");
        colorHover = Color.decode("#593c2e");
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(esit){
            eboard.addRuleCell(new MollaCell(x, inverseY));
