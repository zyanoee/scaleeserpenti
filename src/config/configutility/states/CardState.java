...
public class CardState implements EditBoardState{
    ...
    public CardState(EditBoardView ebview, EditBoardInterface eboard, EditBoardController ebcontroller){
        this.ebview = ebview;
        this.eboard = eboard;
        this.ebcontroller = ebcontroller;
        available = true;
        color = Color.YELLOW;
        colorHover = Color.decode("#ffe180");
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(esit){
            eboard.addRuleCell(new CardCell(x, inverseY));
