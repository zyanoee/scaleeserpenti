...
public class RerollState implements EditBoardState{
    ...
    public RerollState(EditBoardView ebview, EditBoardInterface eboard, EditBoardController ebcontroller){
        this.ebview = ebview;
        this.eboard = eboard;
        this.ebcontroller = ebcontroller;
        available = true;
        color = Color.GREEN;
        colorHover = Color.decode("#90fc92");
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(esit){
            eboard.addRuleCell(new RerollCell(x, inverseY));
